  ...
  },
  {
    ...
    states: [
      ...
      },
      {
        ...
        line: "A synchronous reluctance motor uses steel with air barriers, without magnets or rotor windings. The stator field pulls the rotor's easy magnetic axis into line. The simple rotor saves parts, but lower power factor can mean more current and a larger inverter for the same output. ABB sells industrial SynRM drives. In India, Chara develops and offers reluctance motor-and-controller systems for mobility and industry.",
  ...
  // ── Act IV ──────────────────────────────────────────────────────────────
  {
    ...
    states: [
      ...
      },
      {
        ...
        line: "Induction and wound-field motors already power production cars. Reluctance motors have commercial industrial uses; ferrite traction motors also have tested prototypes. The remaining step differs by design: proving range, sustained power, noise and durability in the intended vehicle, then establishing repeatable manufacture. The table separates those stages. Its costs are extra hardware, energy losses and engineering work, not comparable quoted prices.",
