...
const assessment = [
  ["China is a separate case in the global outlook.", "China supplies the rare-earth magnets that other countries are trying to replace, so its manufacturers face less pressure to switch. As the world’s leading electric-car producer, its motor choices will shape global demand for these magnets. China’s preference for locally made components could further favour continued use of rare-earth PMSMs or other Chinese alternatives."],
