...
const assessment = [
  ...
  ["Ferrite is most likely to succeed in India.", "India’s large electric two- and three-wheeler market gives it the biggest opening. Ferrite keeps a permanent magnetic field without the extra equipment needed to power a wound rotor. Its weaker magnets are easier to accommodate in these lower-power vehicles, though the motor still needs redesigning."],
  ["Outside China, wound field is most likely to replace rare-earth magnets in cars.", "It can provide the strong, controllable magnetic field needed for a car’s main drive, and already does so in production cars. That gives it a head start over ferrite and reluctance designs; cars also have more room than scooters for the equipment that powers and cools the rotor."],
