  ...
  return (
    <div className="group-two-dashboard" aria-labelledby="group-two-title">
      ...
      <div className="group-two-dashboard__intro">
        ...
        <p>
          This is the tightest group in the dataset, and the one where India's exposure is most acute and its options fewest. Every member scores at or near the maximum on three vectors simultaneously: refining concentration, reserve concentration, and extraction complexity. The April 2025 export controls disrupted magnet supplies, affecting automotive manufacturers in Europe and India. This walkthrough examines one possible way to reduce demand for dysprosium and terbium: motors that use less of them or avoid rare-earth magnets altogether.
        </p>
      </div>
      ...
      <div className="landing__grid">
        <section className="landing__copy" aria-labelledby="landing-title">
          ...
          <p className="landing__paragraph">
            On 4 April 2025, China introduced export licensing requirements for seven medium and heavy rare earths and related magnets. The resulting supply delays disrupted some carmakers in Europe and India. These materials are used in permanent magnets inside EV traction motors. A typical permanent-magnet traction motor contains roughly one to two kilograms of magnets. Some grades use small additions of dysprosium or terbium to resist demagnetisation at high temperatures.
          </p>
          <p className="landing__paragraph">
