...
const routes: Route[] = [
  {
    ...
    evidence: <><a href="https://www.press.bmwgroup.com/global/article/detail/T0448099EN/charge-faster-drive-further-bmw-group-reveals-revolutionary-electric-drive-concept-with-800v">BMW</a> retained wound field for its Gen6 rear drive. Automotive supplier <a href="https://press.zf.com/press/en/releases/release_60480.html">ZF</a> is developing compact, contactless excitation. Production use makes this the clearest path to wider adoption in main drives.</>,
  },
  {
    name: "Induction",
  ...
  },
  {
    ...
    evidence: <>Materials maker <a href="https://www.proterial.com/e/press/2023/pdf/20230724en.pdf">Proterial</a> tested a 102 kW prototype at 15,000 rpm against a 110 kW NdFeB reference at 10,000 rpm. In two-wheelers, <a href="https://cdn.olaelectric.com/sites/evdp/pages/investor/announcement/Intimation_of_Press_Release_titled_Ola_Electric_Becomes_India_First_Automotive_OEM_to_Get_Government_Certification_For_its_In-House_Developed_Ferrite_Motor_dated_October_06_2025.pdf">Ola Electric</a> announced ferrite-motor certification in October 2025. These are useful steps toward broader vehicle use.</>,
  },
  {
  ...
  },
  {
    ...
    evidence: <>Motor supplier <a href="https://turntide.com/products/motors/">Turntide</a> sells switched-reluctance systems for ventilation. <a href="https://impact.ornl.gov/en/publications/a-framework-for-multiple-objective-co-optimization-of-switched-re/">Oak Ridge National Laboratory</a> studies motor design and current control together to reduce torque ripple. Refinement for passenger cars gives this route the most demanding near-term path of the five.</>,
  },
];
