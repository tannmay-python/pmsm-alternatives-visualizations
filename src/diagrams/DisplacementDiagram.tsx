...
const assessments: Record<Application, Assessment[]> = {
  ...
  light: [
    ...
    { band: "strong", prospect: "Strong emerging scooter case", reason: "Ola’s certification provides a scooter-specific step toward deployment without rotor excitation hardware.", benefit: "Ferrite has the clearest scooter-specific milestone among the examples here. It keeps permanent-magnet control while eliminating rare-earth magnets. Certification strengthens the adoption case; matching range, hill-climbing and durability at scale remains the vehicle maker’s next task." },
...
const routes: Route[] = [
  {
    ...
    market: {"cars": "BMW’s Gen6 rear drive provides current production evidence.", "light": "Car deployment does not establish a scooter service network or a competitive small-vehicle package.", "commercial": "Car experience is useful, but continuous truck-duty operation and fleet servicing need separate validation."},
  ...
  },
  {
    ...
    control: "Field-oriented control regulates current and torque; current demand and rotor-position estimation must work across the duty cycle.",
    ...
    <section className="clean-diagram displacement" aria-label="Rare-earth magnet displacement prospects">
      <div className="displacement__scroll" data-scrolls tabIndex={0} aria-label="Five alternatives: scroll to compare and open each for details">
        ...
        <details className="displacement__context">
          ...
          <p>The <a href="https://www.iea.org/reports/global-ev-outlook-2026/executive-summary">IEA’s 2026 outlook</a> reports that electric two- and three-wheeler sales grew more than 30% in India in the first quarter of 2026. Globally, electric car sales exceeded 20 million in 2025, while electric truck sales more than doubled. Vehicle volume matters, alongside magnet mass per drive and the number of drives per vehicle.</p>
